...
<form action="/req/register0402" method="post">
    ...
    <p>
        ...
        카드2-유효년월 <input type="text" name="cardVOList[1].validation"/> <br/>
        카드3-번호 <input type="text" name="cardVOList[2].no"/> <br/>
        카드3-유효년월 <input type="text" name="cardVOList[2].validation"/> <br/>
    </p>
    <p> 자기소개:
        <textarea name="introduction" cols="50" rows="6"></textarea>
    </p>
    <p>
