            ...
            <form class="bookInfoFrm" action="/bookInfo/addBookPost" method="post"
                ...
                <div class="form-group row">
                    <div class="col-sm-3 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" value="${data.bookId}"
                               id="bookId" name="bookId" placeholder="도서코드" readonly />
                    </div>
                    <div class="col-sm-6">
                        <input type="text" class="form-control form-control-user" value="${data.name}"
                               id="name" name="name" placeholder="도서명" />
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="number" class="form-control form-control-user" value="${data.unitPrice}"
                               id="unitPrice" name="unitPrice" placeholder="가격" />
                    </div>
                    <div class="col-sm-6">
                        <input type="text" class="form-control form-control-user" value="${data.author}"
                               id="author" name="author" placeholder="저자" />
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" value="${data.publisher}"
                               id="publisher" name="publisher" placeholder="출판사" />
                    </div>
                    <div class="col-sm-6">
                        <input type="date" class="form-control form-control-user" value="${data.releaseDate}"
                               id="releaseDate" name="releaseDate" placeholder="출판일" />
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="number" class="form-control form-control-user" value="${data.totalPages}"
                ...
                <div class="form-group row">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="condition" id="condition1" value="신규도서"
                ...
                <div class="form-group row">
                    <div class="input-group mb-3">
                        <input type="file" class="form-control" id="bookImage" name="bookImage" value="${data.bookImage}"/>
                    </div>
                </div>
